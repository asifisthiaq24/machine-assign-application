...
export class HomePageComponent implements OnInit {
  ...
  //constructor
  constructor(private http: HttpClient, private router: Router, public dialog: MatDialog, private modalService: NgbModal) { }
  //init
  ngOnInit() {
  ...
  getValueForEdit(_id) {
    this.alreadyExistsE=false;
    let resp_post = this.http.post('https://nodejs-mongo-server-asif.herokuapp.com/login/getuser', { id: _id, role: 'admin' })
